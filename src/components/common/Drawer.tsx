    ...
    "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
    {
        variants: {
            side: {
                ...
                bottom:
                    "inset-x-0 bottom-0 border-t mx-1 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
            ...
            radius: {
                ...
                lg: "rounded-lg",
                full: "rounded-full",
                topOnly: "rounded-t-lg",
                bottomOnly: "rounded-b-lg",
            },
        },
        defaultVariants: {
            side: "bottom",
    ...
    <DrawerPortal>
        ...
        <DrawerPrimitive.Content
            ...
            className={cn(
                drawerVariants({ side }),
                className || "",
                "data-[state=open]:drawer-open data-[state=closed]:drawer-close"
            )}
            {...props}
        >
            {children}
