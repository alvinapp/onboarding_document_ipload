...
const OrganizationTable: React.FC = () => {
  ...
  const data: TableData[] = useMemo(
    () => [
      ...
      { customerName: 'Coca-Cola', launchpadStage: '1. Organization Initiation & Kickoff', lastActivity: 'Customer Needs Analysis - 2 PDFs uploaded', activatedUsers: 2 },
      ...
      { customerName: 'Microsoft', launchpadStage: '1. Organization Initiation & Kickoff', lastActivity: 'Customer Needs Analysis - 1 PDF uploaded', activatedUsers: 2 },
